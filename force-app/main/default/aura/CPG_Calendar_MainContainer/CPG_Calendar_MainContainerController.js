({
    doInit : function(component, event, helper) {
        ...
        component.set("v.selectedMonthType", "12");
         ...
         helper.listOfMonthsMethod(component, event,helper,monthNumber);
        component.get("v.monthListMap");
        ...
        helper.callApexMethod(component,helper,"getCalendar",apexConfig,helper.resultCallBack_Summary,callBackConfig);
